...
const char* clientName = "ESP8266testCurveChaChaPolyMQTT_0";
const char* topicSendName = "ESP32Crypto/CurveChaChaPoly/UserName";
const char* topicWill = "ESP32Crypto/CurveChaChaPoly/dc";
char topicAlice[128];
char topicBob[128];
const char* topicAlicePlaintext = "ESP8266testCurveChaChaPolyMQTT_0/plaintext";
const char* topicAliceCiphertext = "ESP8266testCurveChaChaPolyMQTT_0/ciphertext";
const char* topicAliceTag = "ESP8266testCurveChaChaPolyMQTT_0/tag";
...
WiFiClient ESP8266_testCurveChaChaPoly;
PubSubClient client(ESP8266_testCurveChaChaPoly);
...
void callback(String topic, byte* message, unsigned int length) 
{
  ...
  if((!memcmp(topic.c_str(), topicBob, strlen(topic.c_str()))) && !alice_privateKeyState)
  {
      ...
      //Valores para el iv y authDatase toman de la misma llave
