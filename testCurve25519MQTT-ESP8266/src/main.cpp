...
const char* clientName = "ESP8266testCurve25519MQTT_0";
...
WiFiClient ESP8266_testCurve25519;
PubSubClient client(ESP8266_testCurve25519);
...
TransistorNoiseSource noise(A0);  //Seleccionar pin para entrada de ruido
