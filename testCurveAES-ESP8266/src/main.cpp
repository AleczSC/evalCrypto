...
const char* clientName = "ESP8266testCurveAESMQTT_0";
const char* topicSendName = "ESP32Crypto/CurveAES/UserName";
const char* topicWill = "ESP32Crypto/CurveAES/dc";
char topicAlice[128];
char topicBob[128];
const char* topicAlicePlaintext = "ESP8266testCurveAESMQTT_0/plaintext";
const char* topicAliceCiphertext = "ESP8266testCurveAESMQTT_0/ciphertext";
...
WiFiClient ESP8266_testCurveAES;
PubSubClient client(ESP8266_testCurveAES);
...
void loop() 
{
  ...
  if(alice_privateKeyState && (Serial.available() > 0))
  {
    ...
    strToByte(bufferString, vectoraes256.plaintext, bufferString.length(), MAX_PLAINTEXT_SIZE);
