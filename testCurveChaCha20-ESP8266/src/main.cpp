...
const char* clientName = "ESP8266testCurveChaCha20MQTT_0";
const char* topicSendName = "ESP32Crypto/CurveChaCha20/UserName";
const char* topicWill = "ESP32Crypto/CurveChaCha20/dc";
char topicAlice[128];
char topicBob[128];
const char* topicAlicePlaintext = "ESP8266testCurveChaCha20MQTT_0/plaintext";
const char* topicAliceCiphertext = "ESP8266testCurveChaCha20MQTT_0/ciphertext";
...
WiFiClient ESP8266_testCurveChaCha20;
PubSubClient client(ESP8266_testCurveChaCha20);
